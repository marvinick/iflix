...
feature "User interacts with queue" do
  scenario "user adds and reorders videos in the queue" do
    ...
    south_park = Fabricate(:video, title: "South Park", category: dramas)
    futurama = Fabricate(:video, title: "Futurama", category: dramas)
    ...
    expect_link_not_not_to_seen("+ My Queue")
  ...
  def expect_link_not_not_to_seen(link_text)
