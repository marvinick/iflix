...
marvin = User.create(full_name: "marvinick", password_digest: "password", email: "marvin@seasalt.com")
...
monk = Video.create(title: "Monk", description: "bol Funny", small_cover_url: "/tmp/family_guy.jpg", category: dramas,  large_cover_url: "/tmp/monk_large.jpg" )
...
Review.create(user: marvin, video: monk, rating: 3, content: "try try")
Review.create(user: marvin, video: monk, rating: 5, content: "try try")
